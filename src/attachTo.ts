...
export function attachTo(container: Store<ContainerState, ContainerMetaAction>): { as: (as: SubstoreID) => StoreEnhancer<Substore> } {
    return {
        as: (id: SubstoreID): StoreEnhancer<Substore> => (
